...
import { ApiResponse, Recipe } from '~/shared/types/recipe.types';
import { isArrayWithItems } from '~/shared/utils/common';

type JuiciestRecipesProps = {
    juciestRecipes?: ApiResponse<Recipe>;
};

export const JuiciestRecipes: FC<JuiciestRecipesProps> = ({ juciestRecipes }) => {
