        ...
        >
            ...
            >
                {isArrayWithItems(recipes) &&
                    recipes.slice(0, 2).map(({ title, description, bookmarks, likes }, index) => (
                        ...
                        >
                            ...
                            <CardFooter justify='space-between' flexWrap='nowrap' p={0} pt={6}>
                                ...
                                <HStack spacing={4}>
                                    <StatBadge fontSize='sm' icon={heartIcon} count={bookmarks} />
            ...
            >
                {isArrayWithItems(recipes) &&
                    recipes.slice(2, 5).map(({ title }, index) => (
                        // const { currentCategories } = useDishNavigation(categoriesIds, _id);
